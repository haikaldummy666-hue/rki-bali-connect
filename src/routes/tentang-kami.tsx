  ...
  head: () => ({
    meta: [
      { title: "Tentang Kami — RKI Bali" },
      {
        name: "description",
        content:
          "Perjalanan RKI Bali: bermula dari Bapekis Bank Mandiri Bali dan kepeduliaan Bunda Mery & Bu Diana, hingga kini melayani 3 TPQ, 2 Majelis Taklim Ibu, dan Majelis Taklim Bapak di Denpasar.",
      },
      ...
      <section className="container-rki pb-16 md:pb-20">
        ...
        >
          ...
          <p className="mt-5 text-base leading-relaxed text-muted-foreground md:text-lg">
            ...
            Bali</strong>, yaitu Bunda Mery dan Ibu Dian. Menyadari bahwa umat Islam di Bali
            ...
            organisasi Bapekis, Ibu Dian dipercaya mengelola kegiatan di wilayah Bali,
            sementara Bunda Mery menjalankan fungsi bendahara.
          </p>
        </motion.div>
      </section>
