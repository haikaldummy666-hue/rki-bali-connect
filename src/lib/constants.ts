...
export const HISTORY = [
  {
    ...
    body: "Rumah Kajian Islami (RKI) Bali lahir dari inisiatif sosial keagamaan yang diprakarsai oleh dua karyawan Muslim Bank Mandiri Bali, yaitu Ibu Diana dan Ibu Mery. Kepedulian mereka bermula dari kenyataan bahwa umat Islam di Bali merupakan kelompok minoritas, dengan karyawan Muslim yang tersebar di berbagai cabang sehingga sulit saling mengenal dan bertemu. Menjawab kondisi tersebut, keduanya membentuk Bapekis (Badan Kerohanian Islam) Bank Mandiri Bali sebagai wadah resmi untuk kegiatan pengajian, pembinaan rohani, dan penguatan silaturahmi antar-karyawan. Dalam struktur organisasi Bapekis, Ibu Diana dipercaya mengelola kegiatan di wilayah Bali, sedangkan Ibu Mery menjalankan fungsi bendahara. Kegiatan Bapekis berlangsung secara konsisten hingga Ibu Mery memutuskan untuk mengakhiri masa kerjanya di Bank Mandiri pada 1 Juli 2014, sebuah momentum yang kemudian menjadi titik awal berdirinya RKI.",
  },
  {
    year: "1 Juli 2014",
    title: "Titik Tolak Pendirian",
    body: "Pasca-resign, pihak Bank Mandiri melalui lingkungan Bapekis menyampaikan keinginan untuk menyalurkan paket infaq berupa seperangkat alat ibadah, meliputi sajadah, peci, baju sholat, dan perlengkapan ibadah lainnya, kepada komunitas muslim prasejahtera. Melalui komunikasi telepon, Ibu Diana kemudian menghubungi Ibu Mery untuk meminta kesediaannya, meskipun Ibu Mery telah tidak lagi aktif di Bank Mandiri, agar bantuan tersebut dapat disalurkan secara langsung, termasuk pendistribusiannya melalui supir dan pihak terkait. Pendampingan dilakukan menggunakan kendaraan dan supir yang difasilitasi, sehingga proses distribusi dapat menjangkau titik-titik yang terpencil. Dari kegiatan penyaluran inilah ditemukan sebuah pemukiman padat yang menjadi cikal bakal lokasi utama kegiatan RKI hingga saat ini.",
  },
  {
    year: "2014",
