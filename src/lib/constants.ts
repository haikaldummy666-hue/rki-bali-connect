...
export const HISTORY = [
  {
    ...
    body: "Rumah Kajian Islami (RKI) Bali lahir dari inisiatif sosial keagamaan yang diprakarsai oleh dua karyawan Muslim Bank Mandiri Bali, yaitu Bunda Mery dan Ibu Dian. Kepedulian mereka bermula dari kenyataan bahwa umat Islam di Bali merupakan kelompok minoritas, dengan karyawan Muslim yang tersebar di berbagai cabang sehingga sulit saling mengenal dan bertemu. Menjawab kondisi tersebut, keduanya membentuk Bapekis (Badan Kerohanian Islam) Bank Mandiri Bali sebagai wadah resmi untuk kegiatan pengajian, pembinaan rohani, dan penguatan silaturahmi antar-karyawan. Dalam struktur organisasi Bapekis, Ibu Dian dipercaya mengelola kegiatan di wilayah Bali, sedangkan Bunda Mery menjalankan fungsi bendahara. Kegiatan Bapekis berlangsung secara konsisten hingga Bunda Mery memutuskan untuk mengakhiri masa kerjanya di Bank Mandiri pada 1 Juli 2014, sebuah momentum yang kemudian menjadi titik awal berdirinya RKI.",
  },
  {
    year: "1 Juli 2014",
