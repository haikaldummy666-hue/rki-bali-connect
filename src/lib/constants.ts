...
export const HISTORY = [
  {
    ...
    body: "Rumah Kajian Islami (RKI) Bali lahir dari inisiatif sosial keagamaan yang diprakarsai oleh tiga sosok yang memiliki kepedulian terhadap kondisi umat Islam di Bali, yaitu Ibu Mery Lusiana (Bunda Mery), Ibu Diana (Ibu Dian), dan Bapak Kis. Ketiganya aktif dalam Bapekis (Badan Kerohanian Islam) Bank Mandiri Bali, sebuah wadah resmi yang menghimpun karyawan Muslim lintas cabang untuk kegiatan pengajian, pembinaan rohani, dan penguatan silaturahmi. Kepedulian mereka bermula dari kenyataan bahwa umat Islam di Bali merupakan kelompok minoritas, dengan karyawan Muslim yang tersebar di berbagai cabang sehingga sulit saling mengenal dan bertemu. Setelah Bapekis terbentuk, pembagian peran dilakukan secara terstruktur: Ibu Dian dipercaya mengelola kegiatan Bapekis di wilayah Bali, Bunda Mery menjalankan fungsi bendahara, sementara Bapak Kis berperan sebagai penasehat Bunda Mery. Kegiatan Bapekis berlangsung secara konsisten hingga Bunda Mery memutuskan untuk mengakhiri masa kerjanya di Bank Mandiri pada 1 Juli 2014, sebuah momentum yang kemudian menjadi titik awal berdirinya RKI.",
  },
  {
    year: "1 Juli 2014",
    title: "Titik Tolak Pendirian",
    body: "Pasca-resign, Bapak Kis yang masih aktif di lingkungan Bapekis menyampaikan keinginan Bank Mandiri untuk menyalurkan paket infaq berupa seperangkat alat ibadah, meliputi sajadah, peci, baju sholat, dan perlengkapan ibadah lainnya, kepada komunitas muslim prasejahtera. Melalui komunikasi telepon, Ibu Dian kemudian menghubungi Bunda Mery untuk meminta kesediaannya, meskipun Bunda Mery telah tidak lagi aktif di Bank Mandiri, agar bantuan tersebut dapat disalurkan secara langsung, termasuk pendistribusiannya melalui supir dan pihak terkait. Pendampingan dilakukan menggunakan kendaraan dan supir yang difasilitasi, sehingga proses distribusi dapat menjangkau titik-titik yang terpencil. Dari kegiatan penyaluran inilah ditemukan sebuah pemukiman padat yang menjadi cikal bakal lokasi utama kegiatan RKI hingga saat ini.",
  },
  {
    year: "2014",
    title: "Pendirian TPQ Pertama",
    body: "Hasil asesmen lapangan menemukan kondisi yang memerlukan intervensi pendidikan agama secara segera. Faktor utama penyebabnya adalah keterbatasan biaya dan letak lokasi yang sangat terpencil, sehingga guru ngaji hanya dapat hadir sewaktu-waktu dan pembelajaran tidak berjalan berkelanjutan. Selain itu, tingkat pengetahuan agama anak-anak di kawasan tersebut masih sangat minim, disebabkan oleh latar belakang keluarga yang beragam, mulai dari pasangan orang tua yang berstatus mualaf hingga pasangan dengan salah satu atau kedua orang tua non-Muslim. Merespon temuan tersebut, didirikanlah Taman Pendidikan Al-Qur'an (TPQ) pertama di sebuah kamar kos yang disewa, dengan 14 murid awal.",
  },
  {
    year: "2014",
